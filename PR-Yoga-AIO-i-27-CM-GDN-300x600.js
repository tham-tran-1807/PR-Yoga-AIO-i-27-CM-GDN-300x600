...
lib.ssMetadata = [
		{name:"PR_Yoga_AIO_i_27_CM_GDN_300x600_atlas_1", frames: [[0,1806,50,50],[0,0,300,600],[0,602,300,600],[0,1204,300,600],[302,0,300,600],[302,602,300,600],[302,1204,300,600],[604,0,300,600],[604,602,300,600]]}
];
...
(lib.arrows_w = function() {
	this.initialize(ss["PR_Yoga_AIO_i_27_CM_GDN_300x600_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.PRYogaAIOi27CMGDN300x600 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.mc_mui_ten_xoay).wait(360).to({_off:false},0).to({y:11},12).wait(18));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(351).to({_off:false},0).wait(39));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(301).to({_off:false},0).to({_off:true},50).wait(39));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(250).to({_off:false},0).to({_off:true},51).wait(89));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(201).to({_off:false},0).to({_off:true},49).wait(140));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(150).to({_off:false},0).to({_off:true},51).wait(189));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(100).to({_off:false},0).to({_off:true},50).wait(240));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(50).to({_off:false},0).to({_off:true},50).wait(290));

	// Layer_1
	this.instance_7 = new lib.Frame1();
	this.instance_7.setTransform(0,1);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({_off:true},50).wait(340));
...
// library properties:
lib.properties = {
	id: 'F3A132025557504C9F38B753584C1E9F',
	width: 300,
	height: 600,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/PR_Yoga_AIO_i_27_CM_GDN_300x600_atlas_1.png", id:"PR_Yoga_AIO_i_27_CM_GDN_300x600_atlas_1"}
	],
	preloads: []
};
...
an.compositions['F3A132025557504C9F38B753584C1E9F'] = {
